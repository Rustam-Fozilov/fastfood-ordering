...
<head>
    ...
    <title>Fastfood ordering Tashkent</title>
</head>
        ...
        <div class="container">
            ...
            <div id="menu-items">
                <ul class="menu-item-ul">
                    ...
                    <li id="menu2"><a href="#titleBurgeri">BURGERLAR</a></li>
                    <li id="menu3"><a href="#titleTvisteri">TVISTERLAR</a></li>
                    <li id="menu4"><a href="#titleKuritsa">TOVUQ</a></li>
                    <li id="menu5"><a href="#titleFri">KARTOSHKA FRI</a></li>
                ...
                <p class="header-description">Bizning yetkazib berish xizmatimiz siz uchun har kuni soat 09:00 dan 03:00 gacha ishlaydi</p>
            </div>
